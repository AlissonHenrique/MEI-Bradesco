      ...
      var d = {
        ...
        getRegexMask: function () {
          ...
          k &&
            (a = a
              .replace(
                new RegExp("(" + k.digit + "(.*" + k.digit + ")?)"),
                "($1)?"
              )
              .replace(new RegExp(k.digit, "g"), k.pattern));
          return new RegExp(a);
        },
        ...
        calculateCaretPosition: function (a, d) {
          var h = d.length,
            ...
            k = e.length;
          8 === b.data("mask-keycode") && e !== d
            ? (a -= d.slice(0, a).length - e.slice(0, a).length)
            : e !== d &&
              (a =
                a >= k ? h : a + (d.slice(0, a).length - e.slice(0, a).length));
          return a;
        },
