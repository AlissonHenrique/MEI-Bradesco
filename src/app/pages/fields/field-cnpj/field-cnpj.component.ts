...
@Component({
  selector: 'field-cnpj',
  templateUrl: './field-cnpj.component.html',
  styleUrls: ['./field-cnpj.component.scss']
})
export class FieldCnpjComponent implements OnInit, OnChanges {
  @Input('idinput') id: string = "fieldcnpj";
  @Input() value: string = "";
  @Input() placeholder: string = "Cnpj";
  ...
  @Input() fControl = new FormControl(this.value, [
    this.isCNPJ()
  ]);
