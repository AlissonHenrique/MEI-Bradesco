...
@Component({
  selector: 'select-box-v2',
  templateUrl: './select-box-v2.component.html',
  styleUrls: ['./select-box-v2.component.scss']
})
export class SelectBoxComponentV2 implements OnInit {
